...
echo "Setting up files"
 ...
 sed -i '' -e "s/___INSERT_POSTGRESS_USERNAME__BASE64___/${POSTGRESS_USERNAME}/g" udacity-c3-deployment/k8s/env-secret.yaml
 sed -i '' -e "s/___INSERT_POSTGRESS_PASSWORD__BASE64___/${POSTGRESS_PASSWORD}/g" udacity-c3-deployment/k8s/env-secret.yaml
 ...
 sed -i '' -e "s/___INSERT_POSTGRESS_DB___/${POSTGRESS_DB}/g" udacity-c3-deployment/k8s/env-configmap.yaml
 sed -i '' -e "s/___INSERT_POSTGRESS_HOST___/${POSTGRESS_HOST}/g" udacity-c3-deployment/k8s/env-configmap.yaml
